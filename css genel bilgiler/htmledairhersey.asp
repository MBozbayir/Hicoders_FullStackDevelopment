...
<div class="w3-bar w3-card-2 notranslate" style="position: relative;z-index: 4;font-size: 18px;background-color: white;color:#282A35;padding-left:12px;padding-right:16px;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <a class="w3-bar-item w3-button w3-hide-medium bar-item-hover w3-hide-small w3-padding-24 barex" href="https://www.w3schools.com/videos/index.php" onclick="ga('send', 'event', 'Videos' , 'fromTopnavMain')">Videos</a>
  ...
  <div id="loginactioncontainer" class="w3-right w3-padding-16" style="margin-left:50px">
    <div id="mypagediv"></div>
      ...
      <a id="w3loginbtn" class="w3-bar-item w3-btn w3-right" style="display:none;width:130px;background-color:#04AA6D;color:white;border-radius:25px;" href="https://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fmy-learning.w3schools.com" target="_self">Log in</a>
  </div>
...
<nav id="nav_tutorials" class="w3-hide-small" style="position:absolute;background-color:#282A35;color:white;padding-bottom:60px;">
 ...
 <div class="w3-col l3 m6">
   ...
   <a class="w3-bar-item w3-button" href="https://www.w3schools.com/spaces" target="_blank" onclick="ga('send', 'event', 'spacesFromTutorialsAcc', 'click');" title="Get Your Own Website With W3shools Spaces">Website Builder <span class="ribbon-topnav ws-yellow">NEW</span></a>
...
<div id='myAccordion' class="w3-card-2 w3-center w3-hide-large w3-hide-medium" style="width:100%;position:absolute;display:none;background-color:#E7E9EB">
  ...
  <div class="w3-container w3-padding-32">
    ...
    <a class="w3-button w3-block" style="font-size:22px;" href="https://www.w3schools.com/spaces" target="_blank" onclick="ga('send', 'event', 'spacesFromTutorialsAcc', 'click');" title="Get Your Own Website With W3shools Spaces">Spaces</a>
...
<a class="w3-btn w3-margin-bottom"  href="html_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Study our free HTML Tutorial &raquo;</a><br>
<a style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:9px;position:relative;overflow:visible;margin-bottom:1px;" href="https://www.w3schools.com/videos/index.php" onclick="ga('send', 'event', 'Videos' , 'fromHTMLdefault')" class="w3-btn ws-black ws-hover-black" title="HTML video tutorial">Watch our Video Tutorial &raquo;<span class="ribbon-vidx ws-yellow">NEW</span></a><br>
</div>
<hr>
...
<p><a href="html_examples.asp" class="w3-button ws-grey w3-round">Go to HTML Examples!</a></p>
<hr>
...
<p><a href="html_quiz.asp" class="w3-btn w3-blue w3-round">Start HTML Quiz!</a></p>
<hr>

<h2>HTML References</h2>
<p>At W3Schools you will find complete references about HTML elements, 
attributes, events, color names, entities, character-sets, URL encoding, 
language codes, HTTP messages, browser support, and more:</p>


<div class="w3-row-padding" style="margin-left:-16px;margin-right:-16px">

<div class="w3-third">
  <a class="bigbtn" href="/tags/default.asp">HTML Elements</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_html_browsersupport.asp">Browser Support</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_attributes.asp">Attributes</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_standardattributes.asp">Global Attributes</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_eventattributes.asp">Event Attributes</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_colornames.asp">Color Names</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_canvas.asp">Canvas</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_av_dom.asp">Audio/Video DOM</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_charactersets.asp">Character Sets</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_urlencode.asp">URL Encoding</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_language_codes.asp">Language Codes</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_country_codes.asp">Country Codes</a>
</div>


<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_httpmessages.asp">HTTP Messages</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_pxtoemconversion.asp">Px to Em Converter</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/tags/ref_keyboardshortcuts.asp">Keyboard Shortcuts</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="https://courses.w3schools.com/" target="_blank"  onclick="ga('send', 'event', 'Courses' , 'Clicked on ' + foldername + ' course banner in tutorial');">Get certified</a>
...
<!--
<div class="w3-center ws-black htmlvidad w3-padding" style="border-radius:20px;">
  <a href="https://www.w3schools.com/videos/index.php" onclick="ga('send', 'event', 'Videos' , 'fromHTMLdefault')">
    <img src="htmlvideoad2.png" style="max-width:100%;" title="html video tutorial">
  </a>
</div>
-->
...
<div class="sidesection" style="font-family: 'Source Sans Pro', sans-serif;border-radius:5px;color:white;padding-top:25px;margin-left:auto;margin-right:auto;max-width:230px;background-color:#282A35">
  ...
  <a onclick="ga('send', 'event', 'Videos' , 'fromSidebar');" href="https://www.w3schools.com/videos/index.php" class="w3-hover-opacity"><img src="/images/htmlvideoad_footer.png" style="max-width:100%;padding:5px 10px 25px 10px"></a>
